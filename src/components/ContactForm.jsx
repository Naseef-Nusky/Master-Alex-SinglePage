  ...
  return (
    <form onSubmit={handleSubmit} noValidate className={`space-y-4 ${className}`}>
      ...
      <button
        type="submit"
        disabled={isLoading}
        className={`w-full rounded-xl py-3.5 font-semibold transition-all hover:shadow-lg active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-70 ${buttonClass}`}
      >
